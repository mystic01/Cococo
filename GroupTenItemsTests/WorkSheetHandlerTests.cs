...
namespace GroupTenItems.Tests
{
    ...
    public class WorkSheetHandlerTests
    {
        ...
        public void GroupTenItemsTest_OneGroup()
        {
            ...
            excelHandler.GetSpecifiedColumnAllCellValue("完整", "rank").Returns(new Dictionary<int, string> { { 2, "111" }, { 3, "222" } });
            ...
            excelHandler.Received().SetCellValue(2, 2, 3, "222");
        ...
        public void GroupTenItemsTest_TwoGroups()
        {
            ...
            excelHandler.GetSpecifiedColumnAllCellValue("完整", "rank").Returns(new Dictionary<int, string> { { 2, "111" }, { 3, "111" }, { 4, "222" } });
        ...
        public void GroupTenItemsTest_OneBigGroup()
        {
            ...
            excelHandler.GetSpecifiedColumnAllCellValue("完整", "rank").Returns(new Dictionary<int, string> { { 2, "111" }, { 3, "111" }, { 4, "111" }, { 5, "111" }, { 6, "111" }, { 7, "111" }, { 8, "111" }, { 9, "111" }, { 10, "111" }, { 11, "111" }, { 12, "111" } });
